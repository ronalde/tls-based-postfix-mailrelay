...
.PHONY: local live smtpd-server-relay-clientcerts_db rsync clean smtp-client-instruction smtpd-server-instruction ca-key ca-crt smtp-client-key smtp-client-csr smtp-client-crt smtpd-server-client
